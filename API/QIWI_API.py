...
wallet = is_active_wallet()  # Init active wallet
...
# ##-----------------------------------------------------------------
# How much is in the wallet? Check log/main.log
# ##-----------------------------------------------------------------
bal = get_balance()
logging.warning(bal)
...
async def get_history():
    ...
    start_date = end_date - timedelta(days=hst_days)
    try:
